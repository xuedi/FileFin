...
enrich/thumbnail/probe/TMDb/people task really is being worked on.
...
The per-queue `/api/admin/{optimize,enrich,thumbnail,probe,tmdb,people}/active` endpoints remain for the
